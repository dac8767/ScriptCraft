# Style Audit — Full Change List (v7.00, e73d048)

Companion to `docs/STYLE-AUDIT-2026-08-14.md`. Every discrete change is its own
numbered item. Nothing here has been applied.
...
65. Add a global `button, input, select, textarea { font: inherit; }` reset so
    controls stop falling back to the 13.33px UA font.
