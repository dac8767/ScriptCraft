...
## Architecture (already built by the ScriptCraft base)
...
2. **Rebrand** — DONE in this commit: `tauri.conf.json` productName
   ...
   replace the app icons (`src-tauri/icons/*`, still ScriptCraft art) — this is
...
- Replace ALL ScriptCraft brand art (icons, splash, favicon, store images) — T1.
