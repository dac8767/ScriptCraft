...
const StorageFallbackDialog: React.FC = () => {
  ...
  const explanation = isFile
    ? 'ScriptCraft could not open its local database, so your projects are now being saved as individual files in your app data folder. You can keep working — saving and loading still work normally, but version history is disabled until the database is reachable again.'
