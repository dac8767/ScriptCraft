/**
 * Warns the user when ScriptCraft's app data folder is under OneDrive sync.
 *
      ...
      >
        ...
        <div className="dialog-body">
          <p style={{ margin: '0 0 12px' }}>
            ScriptCraft's data folder is inside a OneDrive-synced location. This
          ...
          <ol style={{ margin: '0 0 0 18px', paddingLeft: 0, fontSize: 13, lineHeight: 1.6 }}>
            ...
            <li>
              ...
              (typically Documents or Desktop), or exclude ScriptCraft's app
              data folder explicitly.
            </li>
            <li>Restart ScriptCraft.</li>
          </ol>
        </div>
