...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      { title: 'Customizable transitions', detail: 'Customize ▸ Editor now has a Transitions list: add your own (they appear as you type in a Transition element), and hide built-ins you never use. “WIPE TO:” is now a built-in. Built-ins can be hidden but not deleted; your own can be removed.', tags: ['New Feature', 'Editor'] },
      { title: 'New “Editor” tab in Customize', detail: 'The Customize “Elements” tab is now “Editor” and sits at the top of the list (it covers elements and transitions). Customize now opens on this tab by default, and the window opens lower so it no longer overlaps the ribbon.', tags: ['UI'] },
