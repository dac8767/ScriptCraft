...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      { title: 'Welcome screen SC logo', detail: 'The first-run welcome screen still showed the old “OD” monogram; it now shows “SC” like the rest of the app.', tags: ['Branding', 'Fix'] },
