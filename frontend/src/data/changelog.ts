...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      { title: 'Focus centers the last line of the script', detail: 'At the end of the script there was no room to scroll past the last page, so the current line drifted low. The editor area now gets real over-scroll room below the last page (a half-page beyond), so the line stays centered right to the final line — no waiting for a new page.', tags: ['Fix', 'Tools'] },
