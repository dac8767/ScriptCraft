...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      { title: 'Focus centers the last line of the script', detail: 'At the end of the script there was no room below to keep the current line centered, so it drifted low. The page now gets enough room below the last page — plus half a page of extra scroll — so the current line stays put right to the final line.', tags: ['Fix', 'Tools'] },
